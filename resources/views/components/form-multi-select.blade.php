...
<div class="col-lg-3 col-md-8 col-sm-12">
   ...
   <div wire:ignore >  
    <select data-pharaonic="select2"  multiple data-clear  data-component-id="{{ $this->getId() }}" name="{{$bname}}" wire:key="{{$bname}}" @if($errors->has($bname))style=" box-shadow: 1px 3px 5px #f54747;" @endif multiple 
       wire:model = "{{$bname}}" > 
